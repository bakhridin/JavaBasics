...
public class Task1T {
	public static void main(String[] args) {
		 ...
		 *  price. First, program should check if rate is higher than 4.5 
		 ...
		 */
		 ...
		 if(rate>4.5) {System.out.println("Mortgage very High");
		 }else {
			 System.out.println("I am buying a house");
			 if(price>200000) {System.out.println("I need Mortgage");
			 }else {
